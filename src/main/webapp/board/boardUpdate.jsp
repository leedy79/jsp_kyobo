  ...
  <div id="wrap" align="center">
      ...
      <form name="frm" method="post" action="BoardServlet">
        ...
        <table>
          ...
          <tr>
            <th>제목</th>
            <td><input style="width:100%;" type="text" size="70" name="title" value="${board.title}"></td>
          </tr>
          <tr>
            <th>내용</th>
            <td><textarea style="width:100%;" cols="70" rows="15" name="content">${board.content}</textarea></td>
          </tr>
        </table>
        <br>
        <br> 
